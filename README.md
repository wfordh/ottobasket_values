...
The difference between current and full strength minutes is important to understand. I do not currently have a reliable input for a games played projection and though I hope to have one soon, there will then be the issue of how many minutes to assign the players in these games. This should not be an issue for currently healthy starters, but for injured players who may have minutes restrictions upon returning or the players whose role will be reduced once the starter returns, it will be difficult to calibrate. I have mostly only been looking at the full strength values for players who are out such as Zion Williamson or Ben Simmons to get a feel for how they might stack up whenever they do return to action. This can also distort how teams look when the individual player surplus is rolled up to the team level as someone with a lot of players currently filling big roles and providing value may not look the same once other players return. However, on the whole the current values and projections should be used over the full strength ones. 
